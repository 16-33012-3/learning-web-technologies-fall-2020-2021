        ...
        <fieldset style="display: inline-block;">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td id="usernameError" width="120px" style="color: red;"><?php if(isset($_GET["message"])){echo "*invalid userId or password";}?></td>
                ...
                <tr>
                    ...
                    <td id="passwordError" width="120px" style="color: blue;"></td>
